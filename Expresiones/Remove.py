                        ...
                        if valor_del.tipo[0] == TipoPrimitivo.I64:
                            ...
                            if depth == 0:
                                ...
                                if variable.flag_reference:
                                    ...
                                    valor.codigo = f"\t// REMOVE \n" + valor_del.codigo + f"\t{tmp1} = S + {variable.posicion}; \n" \
                                ...
                                if variable.flag_reference:
                                    ...
                                    # ! Crear código a retornar
                                    valor.codigo = f"\t// REMOVE \n" + valor_del.codigo + f"\t{tmp1} = S - {depth}; \n" \
                            ...
                            valor.codigo += f"\t{tmp1} = H; \n\n" \
                                            ...
                                            f"\tif ({tmp7} != {valor_del.reference}) goto {lbl3}; \n" \
                                            f"\tgoto {lbl4};\n" \
                                            f"\t{lbl3}:\n" \
                                            f"\tHEAP[(int)H] = {tmp10};\n" \
                                            f"\tH = H + 1;\n" \
                            ...
                            valor.codigo += f"\tSTACK[(int){tmpd}] = {tmp1}; \n\n"
